...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2017 at 05:10 AM
...
-- Functions
--
CREATE DEFINER=`root`@`localhost` FUNCTION `getGrade` (`studID` INTEGER, `subjID` INTEGER) RETURNS VARCHAR(1) CHARSET utf8 BEGIN
